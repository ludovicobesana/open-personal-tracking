...
const people = [
  ...
  },
  {
    name: '',
    role: '',
    href: 'https://github.com/ludovicobesana/open-personal-tracking/blob/main/CONTRIBUTING.md#contributing-to-open-personal-tracking',
    slot: true,
  },
  {
    name: '',
    ...
    <main className="page-shell">
      <header className="nav">
        ...
        <nav className="nav-links" aria-label="Main navigation">
          ...
          <a href="https://github.com/ludovicobesana/open-personal-tracking">
            GitHub
          </a>
        </nav>
      </header>
      ...
      <section className="hero" id="top">
        ...
        <p className="lede">
          Trackers shut down. Accounts get deleted. Companies get acquired and
          quietly turned off. Every time, years of ratings, notes, and watch
          history disappear with them. Not here: your history lives on your
          device first, exports on demand, and needs no account to exist.
        </p>

        <div className="cta-row">
          <a className="cta cta-primary" href="/app-shell">
            Open the app
          </a>
          <a
      ...
      <section className="copy why measure">
        ...
        <h2>
          Your history shouldn&apos;t need a company&apos;s permission to keep
          existing.
        </h2>
        <p>
          Every media tracker you&apos;ve loved runs on the same assumption:
          your watch history lives on their servers, behind their account
          system, for as long as their business decides to keep the lights on.
          When that business ends, so does your history, no matter how many
          years you put into it.
        </p>
        <blockquote>
          The application may disappear. Your history must not.
        </blockquote>
        <p className="muted">
          open-personal-tracking is local-first: no account required for the
          core app, full export in a documented format, always. Movies, TV,
          anime, books, manga, games, music, whatever you track, it&apos;s
          yours, on your device, before it&apos;s anyone else&apos;s.
        </p>
      </section>
      ...
      <section className="copy trust measure">
        ...
        <p>
          Every week, the community reviews open issues together on Discord,
          13:00-14:00 (Italy time). Pull requests get read and get a real
          answer, good or bad, not silence. Decisions get written down in the
          open instead of decided in a private channel you weren&apos;t in.
        </p>
        <p className="muted">
          There&apos;s far more to build here than any one person can carry
          alone: providers, importers, storage, accessibility, design,
          translations, testing, docs. First contribution or hundredth, both
          matter, and there&apos;s room for whatever you want to bring to it.
        </p>
      </section>
      ...
      <section className="copy team">
        <div className="measure">
          ...
          <p className="muted">
            This project is built in the open, one contribution at a time, code,
            design, docs, testing, translations, whatever you bring. The roster
            below is still filling up, and there&apos;s a spot open for you.
          </p>
        </div>
      </section>
      ...
      <section className="copy newsletter measure" id="waiting-list">
        ...
        <p className="muted">
          Join the waiting list by email, or drop into Discord to watch it get
          built in real time.
        </p>

        <form
          className="newsletter-form"
          action="https://formsubmit.co/info@ludovicobesana.com"
          method="POST"
          noValidate
        >
          <input
          ...
          <input
            type="hidden"
            name="_subject"
            value="New waiting list signup, open-personal-tracking"
          />
        ...
        <a
          className="cta cta-ghost or-discord"
          href="https://discord.gg/6CjFPH55Rv"
        >
      ...
      <section className="star-cta">
        ...
        <p>
          It takes two seconds, and it&apos;s the easiest way to help someone
          else looking for a tracker like this actually find it.
        </p>
        <a
      ...
      <footer>
        <div className="fine">
          open-personal-tracking is a working name. Posters and covers shown
          above are for illustration only and remain the property of their
          respective owners.
        </div>
        <div className="links">
          <a href="https://discord.gg/6CjFPH55Rv">Discord</a>
